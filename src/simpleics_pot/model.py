...
class WetWellProcess:
    ...
    MAX_PUMP_FLOW_LPS = 15.0
    NOMINAL_INLET_FLOW_LPS = 8.5
    AUTO_HYSTERESIS_RAW = 500  # 5.00 percentage points
    ACTUATOR_DELAY_SECONDS = 2.0
    ...
    def tick(self, seconds: float = 1.0) -> None:
        ...
        with self._lock:
            ...
            self.process_temperature_raw = 1_840 + (phase if phase <= 10 else 20 - phase)
